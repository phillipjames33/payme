    ...
    <Card className={cn('transition-shadow duration-1000', glowClass)}>
      <CardHeader>
        <div className="flex justify-between items-start">
          ...
          <Avatar>
            <AvatarImage
              src={currentDebt.lender.avatar}
              alt={currentDebt.lender.name}
      ...
      <CardContent>
        <div className="prose prose-sm dark:prose-invert bg-secondary/50 p-4 rounded-lg border">
          <p className="text-lg italic leading-relaxed">"{currentDebt.story}"</p>
        </div>
        <p className="text-right text-xs text-muted-foreground mt-2">
          Owed to: {currentDebt.lender.name} by {currentDebt.debtorName}
        </p>
